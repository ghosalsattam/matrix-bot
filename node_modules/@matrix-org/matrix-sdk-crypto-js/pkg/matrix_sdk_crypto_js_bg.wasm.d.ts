...
export function tracing_set_minLevel(a: number, b: number): void;
export function tracing_turnOn(a: number): void;
export function tracing_turnOff(a: number): void;
...
export function olmmachine_importCrossSigningKeys(a: number, b: number): number;
...
export function olmmachine_getUserDevices(a: number, b: number): number;
export function olmmachine_getDevice(a: number, b: number, c: number): number;
...
export function sas_cancelWithCode(a: number, b: number, c: number): void;
...
export function qr_cancelWithCode(a: number, b: number, c: number): void;
export function __wbg_cancelinfo_free(a: number): void;
export function cancelinfo_reason(a: number): number;
export function cancelinfo_cancelCode(a: number): number;
...
export function __wbg_signingkeysuploadrequest_free(a: number): void;
...
export function __wbg_get_signingkeysuploadrequest_body(a: number): number;
...
export function __wbg_get_signingkeysuploadrequest_id(a: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0647808f1e620826(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h079b936a8e792c97(a: number, b: number): void;
export function _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h72dc2e006a980005(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0607f2b70a25bb1c(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4c4e0fa5c912e72f(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h2e19474c2b60c30e(a: number, b: number, c: number, d: number): void;
